...
# installed.
TK_PREFIX='/Users/ethanorel/tldraw-project/.pixi/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/ethanorel/tldraw-project/.pixi/env'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/ethanorel/tldraw-project/.pixi/env/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/ethanorel/tldraw-project/.pixi/env/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/ethanorel/tldraw-project/.pixi/env/include'
...
# compiled.
TK_SRC_DIR='/Users/ethanorel/tldraw-project/.pixi/env/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/ethanorel/tldraw-project/.pixi/env/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/ethanorel/tldraw-project/.pixi/env/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/ethanorel/tldraw-project/.pixi/env/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/ethanorel/tldraw-project/.pixi/env/lib/libtkstub8.6.a'
